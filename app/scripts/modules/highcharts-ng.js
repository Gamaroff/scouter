...
angular.module('highcharts-ng', [])
    .directive('highchart', function () {
        ...
        var getMergedOptions = function (scope, element, config) {
            ...
            if (config.navigator) {
                mergedOptions.navigator = config.navigator;
            }
...
//            }
        ...
        return {
            ...
            link    : function (scope, element, attrs) {
                ...
                scope.$watch("config.navigator", function (navigator) {
                    if (navigator) {
                ...
                scope.$watch("config.legend", function (newLegend, oldLegend) {
                    if (newLegend !== oldLegend) {
                        chart.legend.options.enabled = newLegend || false;
